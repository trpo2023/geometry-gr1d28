...
int main(int argc, char *argv[])
{
    ...
    while(cal > i)
    {
        ...
        if(strcmp(object[i].name, "circle") == 0)
        {
            ...
            printf(" ( %.1f %.1f , %.1f )\n", object[i].point1.number_x, object[i].point1.number_y, object[i].R);
            printf("P = %.4f\n", object[i].P);
            printf("S = %.4f\n\n", object[i].S);
        }
        ...
        {
            printf("%d. %s", i + 1, object[i].name);
            printf(" ( ( %.1f %.1f , %.1f %.1f , %.1f %.1f , %.1f %.1f ) )\n", object[i].point1.number_x, object[i].point1.number_y, \
            object[i].point2.number_x, object[i].point2.number_y, object[i].point3.number_x, object[i].point3.number_y, \
            object[i].point4.number_x, object[i].point4.number_y);
            printf("P = %.4f\n", object[i].P);
            printf("S = %.4f\n\n", object[i].S);
        }
